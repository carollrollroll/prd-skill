...
- For NSM/metrics judgment in any scope, use [../prd-write/principles/nsm-metrics-principles.md](../prd-write/principles/nsm-metrics-principles.md) as the policy reference.
